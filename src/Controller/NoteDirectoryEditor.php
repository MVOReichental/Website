...
#[Route("/internal/notedirectory/editor", name: "NoteDirectoryEditor::", methods: ["GET"])]
#[IsGranted("ROLE_NOTEDIRECTORY_EDITOR")]
class NoteDirectoryEditor extends AbstractController
{
    ...
    {
        return $this->redirectToRoute("NoteDirectoryEditor::getProgramsPage");
    }
    ...
    #[Route("/programs", name: "getProgramsPage")]
