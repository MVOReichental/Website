...
class Account extends AbstractController
{
    ...
    #[Route("/internal/settings", name: "redirectToFirstSettingsPage")]
    #[IsGranted("IS_AUTHENTICATED")]
    public function redirectToFirstSettingsPage(): Response
    {
        return $this->redirectToRoute("Account::showSettings", ["page" => array_keys(self::getSettingsPages())[0]]);
    }
