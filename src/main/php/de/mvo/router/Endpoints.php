...
class Endpoints extends ArrayObject
{
    public function __construct()
    {
        ...
        $this->append(new Endpoint(HttpMethod::POST, "/internal/roomoccupancyplan/entries/[i:id]/move-resize", Target::create()->className(RoomOccupancyPlan::class)->method("moveResizeEntry")->permission("roomoccupancyplan.edit")));
